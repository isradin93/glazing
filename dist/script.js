...
var modals = function modals() {
  var bindModal = function bindModal(triggerSelector, modalSelector, closeBtnSelector) {
  ...
  var showModalByTimeout = function showModalByTimeout(selector, timeout) {
    setTimeout(function () {
  ...
  bindModal('.phone_link', '.popup', '.popup .popup_close'); //showModalByTimeout('.popup', 60000);
};
...
var tabs = function tabs(tabHeaderSelector, tabsSelector, tabContentsSelector, activeClass) {
  var tabHeader = document.querySelector(tabHeaderSelector),
